...
export const MASTER_PRODUCTS = [
  // ── WALL LAMP: LED Wall Lamp ──
  {
    ...
    isPublished: true,
    images: [
      { url: '/categories/led-wall-lamp.jpg', alt: 'LH-WL101 Slim LED Wall Lamp', isCover: true },
    ],
    specifications: {
  ...
  // ── WALL LAMP: E27 Wall Lamp ──
  {
    ...
    description: 'Inspired by mid-century European reading lamps, the LH-WL201 features a fully articulated swing arm and a conical shade in satin brass. Compatible with any standard E27 bulb.',
    price: 3199,
    isFeatured: false,
    isPublished: true,
    images: [
  ...
  // ── PENDANT LAMP: E27 Hanging Lamp ──
  {
    ...
    isPublished: true,
    images: [
      { url: '/categories/e27-hanging-lamp.jpg', alt: 'LH-PL201 Fluted Pendant', isCover: true },
    ],
    specifications: {
  ...
  // ── 6. OUTDOOR LIGHT: Gate Lamp ──
  {
    ...
    isPublished: true,
    images: [
      { url: '/categories/outdoor-light.jpg', alt: 'LH-OD101 Gate Lamp', isCover: true },
    ],
    specifications: {
  ...
  // ── 6. OUTDOOR LIGHT: Outdoor Wall Lamp ──
  {
    ...
    isPublished: true,
    images: [
      { url: '/hero-outdoor.jpg', alt: 'LH-OD201 Outdoor Wall', isCover: true },
    ],
    specifications: {
